...
static const std::string PLAYER_SPRITE_SHEET_A_ATTACK_KEY = "player_sprite_sheet_attack_animation_a";
...
static const std::string PLAYER_SPRITE_SHEET_ATTACK_FILE_PATH = "resources/assets/movement/knight_attack.png";
